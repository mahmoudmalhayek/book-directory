...
input4.setAttribute("id", "text4");
input4.setAttribute("class", "input", "type", "text");
input4.setAttribute("placeholder", "Image URL");
...
addButton.addEventListener("click", function () {
  ...
  if (
    ...
    messages = "Fill all required fields";
    popupContent.append(messages);
  } else {
    let newBook = {
      image: document.getElementById("text4").value,
